...
vector<Vehicle> Vehicle::keep_lane_trajectory(map<int, vector<Vehicle>> &predictions) {
  ...
  //debug
  std::cout<< "keep lane trajectory-> lane:" << lane << " s:" << this->s << " v:"<<this->v <<" a:"<<this->a <<" state:"<<this->state<<std::endl;
  ...
  //debug
  std::cout<< "keep lane trajectory new -> lane:" << this->lane << " s:" << new_s << " v:"<<new_v <<" a:"<<new_a <<"KL"<<std::endl;
  return trajectory;
}
