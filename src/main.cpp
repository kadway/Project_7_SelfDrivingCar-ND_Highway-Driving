        ...
        if (length && length > 2 && data[0] == '4' && data[1] == '2') {
            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                    ...
                    int horizon = 1;
                    road.update_predictions(horizon, prev_size);
                    vector <Vehicle> next_trajectory = my_car.choose_next_state(road.predictions);             
                    my_car.ref_v = next_trajectory[0].v;
                    ...
                    vector<double> next_wp2;
                        ...
                        next_wp0 = getXY(car_s + 30, 2 + 4*next_trajectory[0].lane, map_waypoints_s, map_waypoints_x, map_waypoints_y);
                        ptsx.push_back(next_wp0[0]);
                        ptsy.push_back(next_wp0[1]);
                        next_wp1 = getXY(car_s + 60, 2 + 4*next_trajectory[0].lane, map_waypoints_s, map_waypoints_x, map_waypoints_y);
                        ptsx.push_back(next_wp1[0]);
                        ptsy.push_back(next_wp1[1]);
                        next_wp2 = getXY(car_s + 90, 2 + 4*next_trajectory[0].lane, map_waypoints_s, map_waypoints_x, map_waypoints_y);     
